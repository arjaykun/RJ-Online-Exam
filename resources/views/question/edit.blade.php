...
<div class="card position-relative">
  <div class="card-header py-3 d-flex justify-content-between align-items-center">
    <h6 class="font-weight-bold text-primary">Update Question</h6>
  ...
  <div class="card-body">
    ...
    <form action="{{ route('questions.update', ['test' => $test->id, 'question' => $question->id]) }}" method="post">
      @csrf
      @method('PUT')
      @include('question.form')

      <button class="btn btn-primary float-right mt-2">Save Changes</button>
